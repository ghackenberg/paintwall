...
import { append, div, em, h1, h2, h3, img, li, p, ul } from '../functions/html'
import { BaseScreen } from './base'

export class TermsScreen extends BaseScreen {
    constructor() { 
        ...
        append(this.mainNode, [
            ...
            h1('PaintWall - Terms of use'),
            div(
                p(em("Last updated: Mai 12, 2022")),
                
                h2('Welcome to Paintwall!'),
                ...
                h2('Your Use of the Service'),
                
                h3('Content on the Service'),
                ...
                ul(
                    li(
                        p('access, reproduce, download, distribute, transmit, broadcast, display, sell, license, alter, modify or otherwise use any part of the Service or any Content except: (a) as specifically permitted by the Service; (b) with prior written permission from us and, if applicable, the respective rights holders; or (c) as permitted by applicable law;')
                    ),
                    li(
                        p('circumvent, disable, fraudulently engage, or otherwise interfere with the Service (or attempt to do any of these things), including security-related features or features that: (a) prevent or restrict the copying or other use of Content; or (b) limit the use of the Service or Content;')
                    ),
                    li(
                        p('access the Service using any automated means (such as robots, botnets or scrapers) ')
                    ),
                    li(
                        p('collect or use any information that might identify a person (for example, harvesting usernames or faces), unless permitted by that person or allowed under section 3 above;')
                    ),
                    li(
                        p('use the Service to distribute unsolicited promotional or commercial content or other unwanted or mass solicitations (spam);')
                    ),
                    li(
                        p('cause or encourage any inaccurate measurements of genuine user engagement with the Service.')
                    ),
                    li(
                    ...
                    li(
                        p('run contests on or through the Service')
                    ),
                    li(
                        p('use the Service to view or listen to Content other than for personal, non-commercial use (for example, you may not publicly screen videos or stream music from the Service);')
                    ),
                    li(
                        p('use the Service to: (a) sell any advertising, sponsorships, or promotions placed on, around, or within the Service or Content.')
                    )
                ),
                ...
                h3('Develop, Improve and Update the Service'),
                ...
                h3('Removing your Content'),
                p('You have to get in contact with with our service team.'),
                
                h3('Removal of Content By Paintwall'),
                ...
                h2('Community Guidelines Strikes'),
                ...
                h2('Account Suspension and Termination'),
                
                h3('Terminations by You'),
                p('You can stop using the Service at any time.'),
                
                h3('Effect of Account Suspension or Termination'),
                ...
                h2('About Software in our Service'),
                p(em('Coming soon')),
                ...
                ul(
                    li(
                        p('losses that were not caused by Paintwall or its Affiliates’ breach of this Agreement;')
                    ),
                    li(
                        p('any loss or damage that was not, at the time that this Agreement was formed between you and Paintwall, a reasonably foreseeable consequence of Paintwall or its Affiliates breaching this Agreement; or')
                    ),
                    li(
                        p('the Content submitted by any user, or for the defamatory, offensive, or illegal conduct of any user.')
                    ), 
                ),
                ...
                ul(
                    li(
                        p('Paintwall and its Affiliates will not be responsible for lost profits, revenues, or data; loss of opportunity or anticipated savings; indirect or consequential losses, or punitive damages (in all cases whether such losses were foreseeable or not); and')
                    ),
                    li(
                        p('Paintwall and its Affiliates total liability for any claims arising from or relating to the Service is limited to the greater of: (a) the amount of revenue that Paintwall has paid to you from your use of the Service in the 12 months before the date of your notice, in writing to Paintwall, of the claim and (b) £500, whichever is higher.')
                    ),
                ),
                ...
                h2('About this Agreement'),
                
                h3('Changing this Agreement'),
                ...
                h3('Continuation of this Agreement'),
